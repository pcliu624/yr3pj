...
<link href="web.css" rel="stylesheet" media="all" type="text/css" />
...
<title>Smart home</title>
  ...
  <div class="container">
  <?php    $result = mysqli_query($dbhandle,"SELECT * FROM(SELECT * FROM rfid ORDER BY datetime DESC LIMIT 15) AS c ORDER BY datetime ASC; ");

    echo "
    <table class='table table-hover'>
    <thead>
    <caption><h3>List of card ID record</h3></caption>
